        ...
        <>
            <Container className={classes.container}>
                <Paper className={classes.paper} elevation={3}>
                    <strong className='strong' style={{ color: 'white', fontSize: '45px', display: 'flex', justifyContent: 'center', marginBottom: '20px', }}>
                        Community
                    </strong>
                    <Typography variant='h5'>
                        <strong style={{ display: 'flex', justifyContent: 'center', color: 'white', }}>  Connecting with Movie Professionals</strong>
                    </Typography>
