...
import ArtificialContent from './TextModals/ArtificialContent';
import TexttoVideo from './TextModals/TextToVideo';
        ...
        <>
            ...
            <Container className={classes.container}>
                <Paper className={classes.paper} elevation={3}>
                    ...
                    <Typography variant="body1" className={classes.text}>
                        <strong className='strong'>Filmmaking Experience (AI)</strong><br />
                    ...
                    <Typography variant="body1" className={classes.text}>
                        <strong className='strong' >Text-to-Video Technologies</strong><br />
                    ...
                    <Typography variant="body1" className={classes.text}>
                        <strong className='strong'>Smart Contracts Integration:</strong><br />
                    ...
                    <Typography variant="body1" className={classes.text}>
                        <strong className='strong'>Transparent Transaction Tracking </strong><br />
                    ...
                    <Typography variant="body1" className={classes.text}>
                        <strong className='strong'>Decentralized Governance </strong><br />
