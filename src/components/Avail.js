...
//       <Grid container spacing={4} style={{display:'flex', justifyContent:'center',justifyItems:"center",padding:'5px'}}>
//         {plans.map((plan) => (
...
//                 PER MONTH </span>
//                  </Typography> */}
//                 <Icon icon={plan.Icon} style={{ fontSize: "100px",color:'yellow' }} />
...
//       Icon: "eva:bulb-outline",
//       description:
//         " Additional details can be added here For example planpri planbuttonLabel etc Additional details can be added here Forexample,  Additional details can be added here For example planpri planbuttonLabel etc Additional details can be added here Forexample, v Additional details can be added here For example planpri planbuttonLabel etc Additional details can be added here Forexample, Additional details can be added here For example planpri planbuttonLabel etc Additional details can be added here Forexample, planprice, planbuttonLabel, etcAdditional details can be added here For example, planprice, planbuttonLabel  planpri planbuttonLabel etc Additional details can be added here Forexample, planprice, planbuttonLabel, etcAdditional details can be added here For example, planprice, planbuttonLabel,  Idea to one minute pitch, One minute pitch to synopsis,Synopsis to full length script,Story board,Script doctors, Idea to one minute pitch, One minute pitch to synopsis,Synopsis to full length script,Story board,Script doctors, Idea to one minute pitch, One minute pitch to synopsis,Synopsis to full length script,Story board,Script doctors",
//     },
//     {
//       title: "Movie Professionals",
//       price: 20,
...
//                 style={{ width: "100%", overflow: "scroll", border:'1px solid' }}
//               >
