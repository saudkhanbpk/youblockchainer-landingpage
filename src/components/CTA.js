...
function CTA() {
    ...
    return (
        <Box sx={{ background: 'linear-gradient(91.97deg, #002638 -39.63%, #3770FF 110.12%)',height:{md:'40vh', xs:'22vh'}, margin: '0', padding: '3%', display: 'flex', flexDirection: 'column', justifyContent:'space-evenly', alignItems: 'center' }}>
