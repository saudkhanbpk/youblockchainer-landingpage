...
function CTA() {
    ...
    return (
        <div style={{ background: 'linear-gradient(91.97deg, #7F5288 -39.63%, #3770FF 110.12%)', margin: '0', padding: '3%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <Typography variant='h2' sx={{ fontWeight: 'bold', fontFamily: 'Poppins', fontSize: { md: '35px', sm: '30px', xs: '22px' }, margin: '0', padding: '0' }}><strong style={{ color: 'white' }}>YouBlockchainer </strong></Typography>
