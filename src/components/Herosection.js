                ...
                <Grid container>
                    <Grid item md={7} sm={6} xs={6} sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', paddingLeft: '5%' }}>
                        <div>
                            ...
                            {props.i && <Button onClick={() => window.open('http://app.YouBlockchainer.xyz/')} sx={{ backgroundColor: '#3770FF', color: 'white', border: '2px solid #3770FF', borderRadius: '50px', padding: '0.5% 2%', textTransform: 'none', '&:hover': { color: '#3770FF', border: '2px solid #3770FF' }, fontSize: { md: '15px', sm: '10px', xs: '10px' } }}>Launch App</Button>}
